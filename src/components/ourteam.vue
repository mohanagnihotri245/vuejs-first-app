<template>
  ...
  <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">Our Management</h2>
            ...
            <li v-for="person in people" :key="person.name">
              <div class="group relative space-y-4">
                <div class="aspect-w-3 aspect-h-2">
                  ...
                  <div class="absolute inset-0 flex items-center justify-center rounded-lg bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity">
                    <p class="text-white text-lg font-medium">{{ person.name }}</p>
                  </div>
                </div>
