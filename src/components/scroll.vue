<template>
    <div class="relative overflow-hidden bg-gray-50 py-2.5">
      <div class="scrolling-banner flex items-center">
        <div class="flex-none relative isolate flex items-center gap-x-6 px-6 sm:px-3.5 sm:before:flex-1">
        ...
        <!-- The duplicate content is removed. -->
      </div>
    </div>
  </template>
  ...
  .scrolling-banner > * {
    ...
    min-width: 100%; /* Ensure the content takes up full width */
  }
